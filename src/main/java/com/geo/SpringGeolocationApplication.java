...
public class SpringGeolocationApplication implements CommandLineRunner {
	...
	// Here
	// * you can see I am converting the fullAddress String in UTF-8 format. You
	// will
	...
	// * geocoding request comes from a device with a location sensor. This value
	// must
	...
	//
	// // This is Simple a byte array output stream that we will use to keep the
	// output
	// // data from google.
	...
	// return geocode; // This returned String is JSON string from which you can
	...
	// FileReader(ResourceUtils.getFile("classpath:us-500.csv")));
	// String[] line;
	// int count = -1;
